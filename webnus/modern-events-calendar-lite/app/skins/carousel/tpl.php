...
{       //Load carousel only on homepage(mobile and desktop) and everywhere else only if not mobile
        if ( jQuery("body")[0].classList.contains("home") || ( !jQuery("body")[0].classList.contains("home") && jQuery(window).width() > 480) ) {
            ...
            jQuery("#mec_skin_' . esc_js($this->id) . ' .mec-owl-carousel").addClass("owl-mobile-off");
        }

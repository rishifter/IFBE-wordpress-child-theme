...
if ($this->next_previous_button) {
    ...
    if (
        !isset($this->atts['show_past_events']) or
    ...
    if (
        !$this->show_only_expired_events or
...
<div id="mec_skin_<?php echo esc_attr($this->id); ?>" class="mec-wrap <?php echo esc_attr($event_colorskin . ' ' . $this->html_class . ' ' . $set_dark); ?>">
    ...
    <div class="mec-calendar <?php echo esc_attr($cal_style); ?>">
        ...
        <div class="mec-calendar-side mec-clear">
            ...
            <?php else : ?>
                <div class="mec-calendar-header">
                    <h2><?php echo esc_html($this->main->date_i18n('Y F', $current_month_time)); ?></h2>
                </div>
            <?php endif; ?>
...
<div id="mobile-event-details" class="mobile-event-details"></div>
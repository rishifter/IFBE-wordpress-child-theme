...
$hero = $uploads . '/2022/07/ss-hero-1.jpg';
$img_1 = $uploads . '/2022/07/ss-1.jpg';
$img_2 = $uploads . '/2022/07/ss-2.jpg';
// $img_3 = $uploads . '/2022/06/ss-3.jpg';

$plan = $uploads . '/2022/07/plan-bg.png';
$plan_overlay = $uploads . '/2022/07/plan-overlay-ss.png';
$plan_overlay_color = $uploads . '/2022/07/plan-overlay-red-ss.png';

$plan1 = $uploads . '/2022/07/IFBE_Overall_Space.pdf';
$plan2 = $uploads . '/2022/07/IFBE_The_Substation.pdf';
...
$design_1 = $uploads . '/2022/07/ss-approach.jpg';
$design_2 = $uploads . '/2022/07/ss-thread.jpg';
$design_3 = $uploads . '/2022/07/ss-entrance.jpg';
$design_4 = $uploads . '/2022/07/ss-substation.jpg';
?>
...
<section class="hero full-width title-container flex-col-center">
    ...
    <h2 class="subtitle-bottom">The gateway to IFBE</h2>
</section>

<section class="one full-width flex-col-center">
    <p class="body-text center center-left-on-mobile">
        <span>Abutting Calicut Street, the old substation has been <strong class="highlight">faithfully and innovatively restored</strong></span>
        <span>and now forms <strong class="highlight">a visual gateway</strong> to the central courtyard and The Cathedral beyond.</span>
    </p>
</section>

<section class="two full-width flex-col-center">
    <p class="body-text">
        <span>The gable roof not only allows diffused light to filter into this space</span>
        <span> but also <strong class="highlight">reveals views of the landmark chimney.</strong></span>
    </p>
...
<section class="three full-width flex-col-center flex-jc-top">
    ...
    <p class="body-text">
        <span>The Substation, the gateway to IFBE, is perfect for smaller displays</span>
        <span> or to introduce a larger exhibition being held inside.</span>
    </p>
</section>
...
<section class="five plan-view full-width">
    ...
    <div class="details">
        <div class="features">
            ...
            <div class="feature"><img src="<?php echo $icon_area; ?>" alt="" class="icon"> Area: 580 sq ft</div>
            <div class="feature"><img src="<?php echo $icon_height; ?>" alt="" class="icon">Max Usable Height: 10ft 6in</div>
            <div class="feature"><img src="<?php echo $icon_capacity; ?>" alt="" class="icon">Standing capacity: 45 people</div>
        ...
        <div class="features equipment">
            ...
            <div class="feature"><img src="<?php echo $icon_lighting; ?>" alt="" class="icon"> Lighting:
                <ul>
                    <li>Built-in Adjustable Track Lighting <br />(Warm Colour Temperature)</li>
                </ul>
            </div>
    ...
    <div class="details-blurb flex-col">
        ...
        <div class="blurb">
            <h3 class="title">THE SUBSTATION FLOOR PLAN</h3>
            <h4 class="subtitle">Complete floor plan of The Substation</h4>
...
<section class="plan-zoomed full-width flex-col-center dark">
    <img class="full-width ss" src="<?php echo $plan_overlay; ?>" alt="">
</section>

<section class="plan-details full-width flex-col-center dark">
    <div class="img-container"><img class="full-width ss" src="<?php echo $plan_overlay; ?>" alt=""></div>
    ...
    <div class="details">
        ...
        <div class="features equipment">
            ...
            <div class="feature"><img src="<?php echo $icon_audio; ?>" alt="" class="icon"> Audio:
                <ul>
                    <li>Build-in Speaker/PA System</li>
                    <li>Lapel Mic Available</li>
                </ul>
            </div>
            <div class="feature"><img src="<?php echo $icon_outlet; ?>" alt="" class="icon"> Built-in Floor and Wall Outlets</div>
...
<section class="design-details full-width">
    ...
    <div class="scrollable-cards">
        <div class="card">
            ...
            <div class="heading">The Approach</div>
            <div class="content">Independent access from Calicut Street via elegant French wooden doors</div>
        </div>
        <div class="card">
            <img class="" src="<?php echo $design_2; ?>" alt="">
            <div class="heading">The Thread</div>
            <div class="content">The space visually connects Calicut to Cochin street and
                looks ahead to a majestic banyan tree in the courtyard.</div>
        </div>
        <div class="card">
            <img class="" src="<?php echo $design_3; ?>" alt="">
            <div class="heading">The Entrance</div>
            <div class="content">Giant cooling coils, once used to manufacture ice, are preserved under the glass, giving the
                space a museum-like quality.</div>
        </div>
        <div class="card">
            <img class="" src="<?php echo $design_4; ?>" alt="">
            <div class="heading">The Substation</div>
            <div class="content">The first of IFBE’s diverse exhibition spaces, the Substation is defined by its lineal space, red brick walls and charming Mangalore-tiled gable roof.</div>
        </div>
    </div>
</section>

<?php get_template_part('partials/spaces-animations-ss'); ?>
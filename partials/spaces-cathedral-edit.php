...
<section class="parallax one full-width flex-col-center">
    <p class="body-text center center-left-on-mobile">
        ...
        <span>the soaring Cathedral is a <strong class="highlight">celebration of space, light, and air</strong>.</span>
    </p>
</section>
...
<section class="parallax three full-width flex-col-center flex-jc-top">
    ...
    <p class="body-text">
        <span>The Cathedral, the site's second-largest exhibition space, is in constant conversation with, </span>
        <span>and overlooks, the banyan tree and the central courtyard.</span>
    </p>
</section>
...
<section class="parallax1 five plan-view full-width">
    ...
    <div class="details-blurb flex-col">
        <div class="blurb">
            ...
            <h4 class="subtitle">Complete floor plan for IFBE</h4>
            <a href="<?php echo $plan1 ?>" class="button arrow" target="_blank">Download</a>
        </div>
        <div class="blurb">
            <h3 class="title">THE CATHEDRAL FLOOR PLAN</h3>
            <h4 class="subtitle">Complete floor plan for the Cathedral</h4>
...
<?php get_template_part('partials/spaces-animations-cat-animation-change'); ?>